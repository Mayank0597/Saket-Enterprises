...
const WhyChooseUs = () => {
  ...
  return (
    <div className="relative w-full bg-white md:pb-36 pb-[73px] md:pt-20 pt-[60px] flex flex-col items-center">
      ...
      <div className="hidden md:block relative w-full items-center justify-center mt-10">
      ...
      <div className="md:hidden mt-10 w-full flex flex-col items-center space-y-8">
        {/* Card 1 */}
