...
const InspirationSection = () => {
  return (
    <div className="w-full flex flex-col md:flex-row items-stretch">
      ...
      <div className="bg-[#E9E9E9] flex flex-col justify-center md:px-16 py-6 md:w-[800px] h-[370px] w-full md:py-0">
        <h2 className="text-[#393939] text-3xl md:text-[46px] font-semibold leading-[50px] mb-4">
          Inspiration from the Artifacts we love
        </h2>
        <p className="text-lg md:text-2xl open-sans text-[#808080] mb-9 font-medium">Visit our Website!</p>
