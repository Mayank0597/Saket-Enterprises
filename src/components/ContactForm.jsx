  ...
  return (
    <div className="relative flex justify-center items-center pt-40 pb-32 mr-36">
        ...
        <div className="absolute top-1/4 left-1/4 transform translate-y-1/4 -translate-x-1/5 origin-center justify-center items-center text-white max-w-[407px] w-full">
          ...
          <div className="flex flex-row justify-center items-center">
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-sm">Dhamtari Road, Abhanpur, Chhattisgarh</p>
            </div>
          </div>
      ...
      <div className="relative w-[536px] h-auto p-8 ml-14 bg-[#F3F2F2] z-20">
        <h2 className="text-[46px] mb-4 text-[#393939]">
        ...
        <input
          type="text"
          placeholder="Name"
          className="w-full h-[45px] px-4 border border-gray-300 focus:outline-none mb-4"
        />
        ...
        <textarea
          placeholder="Write a message"
          className="w-full h-[195px] px-4 py-2 border border-gray-300 focus:outline-none resize-none mb-4"
        />

        {/* Submit Button */}
        <button className="w-full h-[45px] bg-[#E2761B] text-white font-bold hover:bg-orange-600">
          Submit
        </button>
      </div>
    </div>
