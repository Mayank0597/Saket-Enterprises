  ...
  return (
    <div className="relative w-full h-[506px]">
      ...
      <div className="absolute inset-0 flex flex-col lg:flex-row justify-center items-center w-full h-full text-white px-6 lg:px-20">
        ...
        <div className="flex flex-col lg:flex-row w-full max-w-screen-lg">
          {/* Section 1 */}
          <div className="flex-1 flex flex-col justify-center items-center text-center px-4 lg:px-4 pr-4 py-6 lg:py-0">
            <h2 className="text-xl lg:text-4xl font-bold mb-4">
              Our <span className="text-[#E2761B]">Mission</span>
            </h2>
            <p className="text-sm lg:text-base text-justify">
              Our mission is to create Exquisite and Handcrafted furniture that
              enhances the beauty and comfort of the living spaces in your
              homes.
            </p>
          </div>
          ...
          {/* Section 2 */}
          <div className="flex-1 flex flex-col justify-center items-center text-center px-4 lg:px-4 pl-4 pr-4 py-6 lg:py-0">
            <h2 className="text-xl lg:text-4xl font-bold mb-4">
          ...
          {/* Section 3 */}
          <div className="flex-1 flex flex-col justify-center items-center text-center px-4 lg:px-4 pl-4 py-6 lg:py-0">
            <h2 className="text-xl lg:text-4xl font-bold mb-4">
