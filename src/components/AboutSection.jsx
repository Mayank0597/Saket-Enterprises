  ...
  return (
    <div className="relative w-full flex flex-col md:flex-row items-start">
      ...
      <div className='flex flex-wrap'>
        ...
        {/* Right-side Content */}
        <div className="flex flex-col justify-center space-y-8 md:pl-60 w-full md:w-2/3 text-justify">
          {/* Heading */}
          <h2 className="text-4xl md:text-5xl font-bold">
          ...
          <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0 md:space-x-8">
            ...
            {/* Vertical Line */}
            <div className="hidden md:block h-24 w-px bg-gray-300 mx-4"></div>
